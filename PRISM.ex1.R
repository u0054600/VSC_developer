...
print.noquote("ready for string")
...
save.image("D18.line.195.R")
# get read taxids  Path 1 original line 196
...
header_taxid = gsub('.*taxid\\|', '', headers) # This is the actual Patch 
