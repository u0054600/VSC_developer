...
save.image("saveImageline_403.Rdata")
...
save.image(paste0(sample, "saveImageline_line438.Rdata"))
cat(paste('Started specific assignment at line 439', Sys.time(), '\n'))


print.noquote ("second patch performed here, ita est a replacemnt of multisession by a loop")
...
### 
print.noquote("end of patch #2, line 494")
